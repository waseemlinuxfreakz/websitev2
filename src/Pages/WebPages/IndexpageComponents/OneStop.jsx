                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6">
                                    <div className="onestopBox">
                                        ...
                                        <p>Bridge your assets cross-chain. Earn rewards and access EMMET liquidity pools</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="onestopBox">
                                        ...
                                        <p>Experience seamless and secure asset exchanges with Emmet Finance's cutting-edge swap feature, designed for efficiency and simplicity</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="onestopBox">
                                        ...
                                        <p>Lock your EMMET tokens and receive veEMMET governance token. Become a part of EMMET finance ecosystem</p>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6">
                                    <div className="onestopBox">
                                        ...
                                        <p>Unlock boundless financial possibilities by depositing assets to earn interest and accessing borrowing capabilities across multiple chains</p>
                                    </div>
                                </div>
                                <div className="col-lg-8 col-md-12">
                                    <div className="onestopBox lastOnestop">
                                        ...
                                        <p>Contribute liquidity across various blockchain networks, earning rewards to seize the full potential of your digital assets and bolster the Emmet DeFi protocol</p>
                                    </div>
                                </div>
                            </div>
                        </div>
