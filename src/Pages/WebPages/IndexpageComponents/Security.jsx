                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="securityBox">
                                <img src={Security1} className='securityIcon' alt="Security Audits" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="securityBox">
                                <img src={Security2} className='securityIcon' alt="Red Team Pentesting" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="securityBox">
                                <img src={Security3} className='securityIcon' alt="Blue Team Honeypots" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="securityBox">
                                <img src={Security4} className='securityIcon' alt="Secure Infrastructure" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="securityBox">
                                <img src={Security5} className='securityIcon' alt="Bug Bounty Program" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="securityBox">
                                <img src={Security6} className='securityIcon' alt="AI/ML Security Alerts" />
